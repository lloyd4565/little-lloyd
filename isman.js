...
⭔ Url : ${anu.url}`,
		...
		let cnvrt = await toAudio(nganu, 'mp4')
                isman.sendMessage(m.chat, { audio: cnvrt, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
            ...
            case 'list': case 'menu': case 'help': case '?': {
                anu = `_Selamat Datang Di Isman Botz_

*Group Menu*
_${prefix}linkgroup_
_${prefix}ephemeral [option]_
_${prefix}setppgc [image]_
_${prefix}setname [text]_
_${prefix}setdesc [text]_
_${prefix}group [option]_
_${prefix}editinfo [option]_
_${prefix}add @user_
_${prefix}kick @user_
_${prefix}hidetag [text]_
_${prefix}tagall [text]_
_${prefix}promote @user_
_${prefix}demote @user_
_${prefix}vote [text]_
_${prefix}devote_
_${prefix}upvote_
_${prefix}cekvote_
_${prefix}hapusvote_
...
_${prefix}tiktokmp3 [url]_
_${prefix}instagram [url]_
_${prefix}twitter [url]_
_${prefix}twittermp3 [url]_
_${prefix}facebook [url]_
_${prefix}pinterestdl [url]_
_${prefix}ytmp3 [url]_
_${prefix}ytmp4 [url]_
_${prefix}getmusic [query]_
_${prefix}getvideo [query]_
_${prefix}umma [url]_
...
_${prefix}yts [query]_
_${prefix}google [query]_
_${prefix}gimage [query]_
_${prefix}pinterest [query]_
_${prefix}wallpaper [query]_
_${prefix}wikimedia [query]_
_${prefix}ytsearch [query]_
_${prefix}ringtone [query]_
...
_${prefix}tictactoe_
_${prefix}family100_
_${prefix}tebak [option]_
_${prefix}math [mode]_
_${prefix}suitpvp [@tag]_
...
*Owner Menu*
_${prefix}chat [option]_
_${prefix}join [link]_
_${prefix}leave_
_${prefix}block @user_
_${prefix}unblock @user_
_${prefix}bcgroup [text]_
_${prefix}bcall [text]_
